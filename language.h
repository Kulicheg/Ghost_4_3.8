...
#define MSG_ERR_NO_THERMISTORS              "No thermistors - no temperature"    // 固件改名字修改版本//
#define MSG_M115_REPORT                     "FIRMWARE_NAME:Marlin Ghost_V3.8 " DETAILED_BUILD_VERSION " SOURCE_CODE_URL:" SOURCE_CODE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) " UUID:" MACHINE_UUID
